...
passport_1.default.use(new passport_google_oauth20_1.Strategy({
    ...
    try {
        ...
        const email = (_f = (_e = profile.emails) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.value; // Use the value property
        const existingUser = yield user_1.default.findOne({ where: { email } });
        if (existingUser) {
            return done(null, existingUser);
        }
        ...
        const newUser = yield user_1.default.create({
            email,
            firstName: (_g = profile.name) === null || _g === void 0 ? void 0 : _g.givenName,
