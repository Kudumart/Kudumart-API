...
userRoutes.get("/cart/charges", authMiddleware_1.default, userController.getCartCharges);
userRoutes.get("/payment/gateway", authMiddleware_1.default, userController.getActivePaymentGateways);
userRoutes.get("/shipping/addresses", authMiddleware_1.default, userController.getAliexpressAddressOptions);
userRoutes.get("/delivery-fees", authMiddleware_1.default, userController.calculateAliexpressDeliveryFee);
userRoutes.post("/checkout", authMiddleware_1.default, userController.checkout);
userRoutes.post("/checkout/naira/prepare", authMiddleware_1.default, userController.prepareCheckoutNaira);
userRoutes.post("/checkout/dollar", authMiddleware_1.default, userController.checkoutDollar);
userRoutes.post("/checkout/dollar/prepare", authMiddleware_1.default, userController.prepareCheckoutDollar);
...
userRoutes.post("/service/review", authMiddleware_1.default, userController.addServiceReview);
userRoutes.post("/service/:serviceId/bookings", (0, validations_1.validateUUIDParam)("serviceId"), validations_1.validate, (0, validations_1.ValidateServiceBooking)(), validations_1.validate, authMiddleware_1.default, userController.bookService);
userRoutes.get("/service/bookings", authMiddleware_1.default, userController.getUserServiceBookings);
userRoutes.patch("/service/bookings/:bookingId/complete", authMiddleware_1.default, userController.markServiceBookingComplete);
userRoutes.patch("/service/bookings/:bookingId/cancel", authMiddleware_1.default, userController.cancelServiceBooking);
// Product offer routes
userRoutes.post("/products/:productId/offers", authMiddleware_1.default, userController.submitOffer);
userRoutes.get("/offers", authMiddleware_1.default, userController.getMyOffers);
userRoutes.put("/offers/:offerId/respond", authMiddleware_1.default, userController.respondToCounterOffer);
userRoutes.post("/offers/:offerId/initiate-payment", authMiddleware_1.default, userController.initiateOfferPayment);
userRoutes.post("/offers/:offerId/checkout", authMiddleware_1.default, userController.checkoutOffer);
