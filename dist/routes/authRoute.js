...
authRoutes.post("/auth/verify/email-token", (0, validations_1.verificationTokenValidationRules)(), validations_1.validate, authController.verifyEmailWithToken);
...
authRoutes.get("/service/categories", (0, validations_1.paginationQueryParamsValidation)(), validations_1.validate, homeController.getAllServiceCategories);
authRoutes.get("/service/subcategories/:id", (0, validations_1.ServiceIdValidation)(), (0, validations_1.paginationQueryParamsValidation)(), validations_1.validate, homeController.getAllServiceSubCategories);
authRoutes.get("/services", (0, validations_1.paginationQueryParamsValidation)(), validations_1.validate, homeController.getAllServices);
authRoutes.get("/service/:serviceId", (0, validations_1.validateUUIDParam)("serviceId"), validations_1.validate, homeController.getServiceById);
authRoutes.get("/services/:serviceId/reviews", (0, validations_1.validateUUIDParam)("serviceId"), (0, validations_1.paginationQueryParamsValidation)(), validations_1.validate, homeController.getServiceReviews);
authRoutes.get("/services/categories/:categoryId/attributes", (0, validations_1.paginationQueryParamsValidation)(), homeController.getAttributesForServiceCategory);
authRoutes.post("/aliexpress/create-account", adminAuthMiddleware_1.default, authController.createAliexpressAccount);
authRoutes.get("/aliexpress/auth", authController.aliExpressAuth);
authRoutes.get("/aliexpress/auth-callback", authController.aliExpressAuthCallback);
